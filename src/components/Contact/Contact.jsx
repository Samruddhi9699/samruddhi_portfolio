 ...
 */
const WEB3FORMS_KEY =
  import.meta.env.VITE_WEB3FORMS_KEY || "8fda10e2-17f2-47b8-9044-32821d475048";

const WHATSAPP_NUMBER = "919699810802";
...
function Contact() {
  ...
  const whatsappHref = () => {
    ...
    const greeting = name ? `Hi Samruddhi, this is ${name}.` : "Hi Samruddhi,";
        ...
        <form onSubmit={sendMail} className="bg-panel border border-seam p-6 rounded-md">
          ...
          {status === "error" && (
            <p className="font-mono text-sm text-copper mt-4">
              That didn&apos;t go through. Try WhatsApp above, or email samruddhisonwane20@gmail.com.
            </p>
          )}
        </form>
      </div>
